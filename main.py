...
def define_env(env):
    ...
    env.variables['projet_premiere']={
        ...
        3 : ["projet","Pygame : Introduction","05/06/2023","T08_Extras/3Pygame/01-Pygame_intro.md"],
        4 : ["projet","Pygame : Animation simple","05/06/2023","T08_Extras/3Pygame/02-Pygame_image.md"],
        5 : ["projet","Pygame : Gestion des évènements","05/06/2023","T08_Extras/3Pygame/03-Pygame_events.md"],
        6 : ["projet","Pygame : Textes, dessins, fenêtres","05/06/2023","T08_Extras/3Pygame/04-Pygame_extras.md"]
        #7 : ["python","Les boucles WHILE",1,"T06_Python/T6.1_Python/T6_1_4_WHILE.md"],
        #8 : ["python","Les instructions conditionnelles",1,"T06_Python/T6.1_Python/T6_1_5_Instructions_conditionnelles.md"],
        #9 : ["python","Exercices Bilan Python",1,"T06_Python/T6.1_Python/T6_1_6_Exercices_Bilan_Bases.md"]
...
#---------------- <exo perso>-------------------- 
    ...
    @env.macro
    def capytale(id):
        lien = "[![logo capytale](https://fabricenativel.github.io/images/capytale.png){.center width=150px border=2px}]"
